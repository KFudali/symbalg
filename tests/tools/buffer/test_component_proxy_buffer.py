...
def test_component_proxy_single_shapes():
    ...
    zero_comp = ComponentProxyValueBuffer(source, (0, slice(None)))
    one_comp = ComponentProxyValueBuffer(source, (1, slice(None)))
    two_comp = ComponentProxyValueBuffer(source, (2, slice(None)))
